...
TumblrClient.prototype = {
  ...
  _post: function (path, params, callback) {
    ...
    var r = request.post(baseURL + path, function (err, response, body) {
      try {
        /* 
           after plenty of normal use and regular errors (404, etc) being handled
           this line threw a parse error for what appears to be an html tag, although
           I do not have that data available and have not been able to repeat this
           crash yet;
           
    SyntaxError: Unexpected token <
    at Object.parse (native)
    at Request._callback (/T260Gtumblr/node_modules/tumblr.js/lib/tumblr.js:178:19)
    ...
    at process._tickCallback (node.js:415:13)
        ...
        */
        ...
        // deal with parsing error properly
      }
