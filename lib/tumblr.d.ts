...
export type TumblrClientCallback = (
  err: Error | null,
  resp: any | null,
  response?: http.IncomingMessage | null | undefined,
) => void;
/**
 * @typedef Options
...
declare class TumblrClient {
  ...
  getRequest(
    apiPath: string,
    paramsOrCallback?: Record<string, any> | TumblrClientCallback | undefined,
    callback?: TumblrClientCallback | undefined,
  ...
  blogAvatar(
    ...
    paramsOrCallback?:
      ...
      | undefined,
    maybeCallback?: TumblrClientCallback | undefined,
  ): Promise<any> | undefined;
  /**
