declare module 'tumblr.js' {
  ...
  class TumblrClient {
    ...
    createTextPost(
      blogIdentifier: string,
      options: TextPostParams,
      callback: TumblrClientCallback,
    ): void;
    createPhotoPost(
      blogIdentifier: string,
      options: PhotoPostParams,
      callback: TumblrClientCallback,
    ): void;
    createQuotePost(
      blogIdentifier: string,
      options: QuotePostParams,
      callback: TumblrClientCallback,
    ): void;
    createLinkPost(
      blogIdentifier: string,
      options: LinkPostParams,
      callback: TumblrClientCallback,
    ): void;
    createChatPost(
      blogIdentifier: string,
      options: ChatPostParams,
      callback: TumblrClientCallback,
    ): void;
    createAudioPost(
      blogIdentifier: string,
      options: AudioPostParams,
      callback: TumblrClientCallback,
    ): void;
    createVideoPost(
      blogIdentifier: string,
    ...
    getRequest(
      apiPath: string,
      paramsOrCallback?: object | null | TumblrClientCallback,
      callback?: TumblrClientCallback,
    ): Request;
    postRequest(
      apiPath: string,
  ...
  type PhotoPostParams =
    | PhotoPostParamsWithSource
    | PhotoPostParamsWithData
    | PhotoPostParamsWithData64;
